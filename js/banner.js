...
xhr.open('GET', 'https://179523.selcdn.ru/public/delivery-banner/lang.json', true);
...
function main () {
  ...
  let mainDocLang = 'en'; // язык вывода текста в баннере
  ...
  function resizeHeight() {
      let mainHeight = $('.main-banner').outerHeight(),
      mTop = mainHeight + 'px!important',
      mBottom = mainHeight + 'px!important';
